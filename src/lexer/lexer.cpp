...
namespace lexer{
    ...
    std::vector<Token> tokenize_statement(const std::string& code, int& lineNumber){
        ...
        for (; i < len; ++i) {
            ...
            switch (c) {
                case '=': tokens.push_back({TokenType::ASSIGN, "=", lineNumber}); break;
                case '+': tokens.push_back({TokenType::PLUS, "+", lineNumber}); break;
                case '-': tokens.push_back({TokenType::SUBTRACT, "-", lineNumber}); break;
                case '*': tokens.push_back({TokenType::MULTIPLY, "*", lineNumber}); break;
                case '/': tokens.push_back({TokenType::DIVIDE, "/", lineNumber}); break;
                case '<': tokens.push_back({TokenType::LESSTHAN, "<", lineNumber}); break;
                case '>': tokens.push_back({TokenType::GREATERTHAN, ">", lineNumber}); break;
                case ':': tokens.push_back({TokenType::COLON, ":", lineNumber}); break;
                default:
